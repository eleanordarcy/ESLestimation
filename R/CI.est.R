...
CI.est <- function(p, data, ci.prob, gpd_par, rate_par, extremalindex_par, block.length=10, n.boot=200, gpd.quantile=0.95, optim.method='BFGS',
  ...
  for(j in 1:n.boot){
    ...
    annmax.sealevel.dist <- function(z){
      ...
      for(i in 1:period){
        F_m_s <- c()
        F_m_s[1] <- monmax.sealevel.dist(z,data,1,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[2] <- monmax.sealevel.dist(z,data,2,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[3] <- monmax.sealevel.dist(z,data,3,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[4] <- monmax.sealevel.dist(z,data,4,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[5] <- monmax.sealevel.dist(z,data,5,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[6] <- monmax.sealevel.dist(z,data,6,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[7] <- monmax.sealevel.dist(z,data,7,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[8] <- monmax.sealevel.dist(z,data,8,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[9] <- monmax.sealevel.dist(z,data,9,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[10] <- monmax.sealevel.dist(z,data,10,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[11] <- monmax.sealevel.dist(z,data,11,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
        F_m_s[12] <- monmax.sealevel.dist(z,data,12,base_yr + (i-1), gpd_boot_par, rate_boot_par, extremalindex_boot_par, lin.int = EI_lin.interp, emp = empiricals)
