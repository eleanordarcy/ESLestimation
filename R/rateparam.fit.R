...
#' To fit the model, we assume the rate parameter follows a Bernoulli distribution, and use an indicator function to determine whether an observation exceeds it's monthly quantile.
#' 
